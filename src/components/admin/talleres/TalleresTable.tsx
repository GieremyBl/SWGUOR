...
interface TalleresTableProps {
  ...
  onManageTarifas: (taller: Taller) => void;
}
      ...
      <Table>
        ...
        <TableBody>
          {data.map((taller) => {
            ...
            const direccionTruncada =
              direccionTexto.length > 25
            ...
            return (
              ...
              >
                ...
                <TableCell>
                  <div className="flex flex-col gap-1">
                    <div className="flex items-center text-xs text-gray-600">
                      <Phone className="w-3 h-3 mr-1 text-pink-500 shrink-0" />
                      {taller.telefono}
                    </div>
                ...
                <TableCell>
                  <Badge
                    variant="outline"
                    className="bg-pink-50 text-pink-700 border-pink-100 capitalize"
                  >
                    {taller.especialidad}
                  </Badge>
                </TableCell>
                ...
                <TableCell>
                  <Badge
                    className={`${
                      STATUS_STYLES[estadoKey] ||
                      "bg-gray-100 text-gray-600 border-gray-200"
                    } capitalize border shadow-none`}
                  >
                    {taller.estado}
                  </Badge>
                </TableCell>
                ...
                <TableCell className="text-right">
                  <DropdownMenu>
                    ...
                    <DropdownMenuContent align="end" className="w-52">
                      ...
                      <DropdownMenuItem
                        onClick={() => onManageTarifas(taller)}
                      >
